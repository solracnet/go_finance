...
func (q *Queries) GetAccountsByUserIdAndType(ctx context.Context, arg GetAccountsByUserIdAndTypeParams) ([]GetAccountsByUserIdAndTypeRow, error) {
	rows, err := q.query(ctx, q.getAccountsByUserIdAndTypeStmt, getAccountsByUserIdAndType, arg.UserID, arg.Type)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetAccountsByUserIdAndTypeAndCategoryId(ctx context.Context, arg GetAccountsByUserIdAndTypeAndCategoryIdParams) ([]GetAccountsByUserIdAndTypeAndCategoryIdRow, error) {
	rows, err := q.query(ctx, q.getAccountsByUserIdAndTypeAndCategoryIdStmt, getAccountsByUserIdAndTypeAndCategoryId, arg.UserID, arg.Type, arg.CategoryID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetAccountsByUserIdAndTypeAndCategoryIdAndDescription(ctx context.Context, arg GetAccountsByUserIdAndTypeAndCategoryIdAndDescriptionParams) ([]GetAccountsByUserIdAndTypeAndCategoryIdAndDescriptionRow, error) {
	rows, err := q.query(ctx, q.getAccountsByUserIdAndTypeAndCategoryIdAndDescriptionStmt, getAccountsByUserIdAndTypeAndCategoryIdAndDescription,
		arg.UserID,
		arg.Type,
		arg.CategoryID,
		arg.Description,
...
func (q *Queries) GetAccountsByUserIdAndTypeAndCategoryIdAndTitle(ctx context.Context, arg GetAccountsByUserIdAndTypeAndCategoryIdAndTitleParams) ([]GetAccountsByUserIdAndTypeAndCategoryIdAndTitleRow, error) {
	rows, err := q.query(ctx, q.getAccountsByUserIdAndTypeAndCategoryIdAndTitleStmt, getAccountsByUserIdAndTypeAndCategoryIdAndTitle,
		arg.UserID,
		arg.Type,
		arg.CategoryID,
		arg.Title,
...
func (q *Queries) GetAccountsByUserIdAndTypeAndCategoryIdAndTitleAndDescription(ctx context.Context, arg GetAccountsByUserIdAndTypeAndCategoryIdAndTitleAndDescriptionParams) ([]GetAccountsByUserIdAndTypeAndCategoryIdAndTitleAndDescriptionRow, error) {
	rows, err := q.query(ctx, q.getAccountsByUserIdAndTypeAndCategoryIdAndTitleAndDescriptionStmt, getAccountsByUserIdAndTypeAndCategoryIdAndTitleAndDescription,
		arg.UserID,
		arg.Type,
		arg.CategoryID,
		arg.Title,
